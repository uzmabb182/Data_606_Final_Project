...
```{r}
### In this study, 249 mice identified with Squamous cell carcinoma (SCC) tumor growth were treated through a variety of drug regimens. 
...
```{r}
### The response variable is the "Tumor.Volume..mm3." and it holds a numerical data.
